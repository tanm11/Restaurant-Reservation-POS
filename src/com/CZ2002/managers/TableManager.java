...
public class TableManager extends Manager<Table> {
    private final int index2Seater;
    private final int index4Seater;
    private final int index6Seater;
    private final int index8Seater;
    private final int index10Seater;
    ...
    public int getAvailableTable(int[] unavailableTableNos, int pax) throws IllegalArgumentException, NullPointerException {
        ...
        return entities
                ...
                .stream()
                .filter(table -> (!set.contains(table.getTableNumber())))
                .findFirst()
                .get()
                .getTableNumber();
    }
